...
import com.terafort.onereads.databinding.FragmentPPTBinding
import com.terafort.onereads.databinding.FragmentTXTBinding
...
class TXTFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.txtrecycleralldocuments.layoutManager = LinearLayoutManager(requireContext(),
            LinearLayoutManager.VERTICAL,false)
        homeadapter = AdapterHomeFiles(listOf())
        binding.txtrecycleralldocuments.adapter=homeadapter
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val imageView = binding.txtimageView2
